...
// Solo los setpoints escribibles se envían al backend
const WRITABLE_KEYS: (keyof CarriageControlData)[] = [
    'carriageControlEncendido',
    'carriageTorque',
    'carriageCambioPosicion',
    'carriagePosicion1',
    'carriagePosicion2',
    'carriageVelocidadPosicion',
];
...
export const CarriageControlPanel: React.FC = () => {
    ...
    const handleSave = async () => {
        ...
        setStatus('idle');
        try {
            const payload: Partial<CarriageControlData> = {};
        ...
        <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm p-4">
            ...
            <div className="space-y-3">
                <div className="flex items-center justify-between p-3 rounded-lg bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700">
                    ...
                    <button
                        onClick={() => handleChange('carriageControlEncendido', encendido ? 0 : 37)}
                ...
                <NumberField icon="looks_one" label="Posición 1" unit="mm" value={draft.carriagePosicion1} min={0} max={2000} onChange={v => handleChange('carriagePosicion1', v)} />
                <NumberField icon="looks_two" label="Posición 2" unit="mm" value={draft.carriagePosicion2} min={0} max={2000} onChange={v => handleChange('carriagePosicion2', v)} />
